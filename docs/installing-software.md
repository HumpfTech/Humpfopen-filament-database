...
2. Attempt to auto-install Python if missing (Linux/macOS only, via apt/dnf/pacman/brew)
3. Create a Python virtual environment
4. Install Python dependencies

Node.js dependencies are installed lazily - only when you first run `./ofd.sh webui` or `ofd.bat webui`
